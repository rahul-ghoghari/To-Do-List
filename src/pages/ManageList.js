...
export default function ManageList() {
  ...
  async function getData() {
    email = decryptData("email");
    await fetch(baseUrl + "/getData/" + email)
      .then((res) => res.json())
      .then((data) => {
        setProducts(data);
        debugger;
  ...
  async function updateData() {
    ...
    debugger;
    await axios
      .put(baseUrl + "/UpdateList/" + formId, data)
      .then((res) => {
        console.log(res);
        handleClose();
        getData();
  ...
  const deleteData = (row) => {
    ...
    if (cnf == true) {
      axios
        .delete(baseUrl + "/DeleteList/" + row._id)
        .then(() => {
